...
export default function AboutUs() {
  return (
    // Внешний блок — фон edge-to-edge, без горизонтальных отступов
    <div className="w-full bg-[#001E40] text-white">
      {/* Внутренний контейнер — единые X-отступы */}
      <SectionInner className="min-h-screen md:min-h-[100dvh] py-12 sm:py-16 md:py-0 flex flex-col md:flex-row md:justify-between md:items-center gap-10 md:gap-12">
