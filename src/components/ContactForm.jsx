      ...
      <div className="w-full max-w-[1040px] lg:flex lg:justify-between lg:items-center lg:gap-[60px]">
        <div className="hidden lg:flex flex-col lg:order-1 lg:flex-1">
          ...
          <p className="font-normal text-[16px] leading-[26px] text-[#43474F] max-w-[440px] mb-[48px]">
            Получите детальное предложение и расчет стоимости перевозки в
            течение 2 часов.
          </p>
          ...
          <div className="bg-[#F4F7FC] shadow-xl p-[16px] sm:p-[24px] lg:p-[48px]  w-full max-w-[500px] mb-[48px] lg:mb-0 mx-auto lg:mx-0 lg:sticky lg:top-[120px]">
            ...
            {status === "success" ? (
              ...
              <form
                ...
                className="mt-[12px] lg:mt-0 flex flex-col gap-[12px] lg:gap-[32px] mb-[8px] lg:mb-[25px]"
                noValidate
              >
                <div className="flex flex-col gap-[4px] lg:gap-[0px]">
                  <label
                    htmlFor="name"
                    className="font-medium text-[10px] leading-[14px] lg:leading-[15px] uppercase text-[#003B73]"
                  >
                    Ваше имя
                  </label>
                  <input
                ...
                <div className="flex flex-col gap-[4px] lg:gap-[0px]">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option value="Автомобильные перевозки">
                        Автомобильные перевозки
                      </option>
                      <option value="Железнодорожные перевозки">
                        Железнодорожные перевозки
                      </option>
                      <option value="Мультимодальные перевозки">
        ...
        <div className="lg:hidden flex flex-col gap-[20px]">
          <div className="flex items-center gap-[12px]">
            ...
            <div>
              <p className="font-medium text-[10px] text-[#003B73] mb-[2px]">
                Телефон
              </p>
              <p className="font-bold text-[14px] leading-none text-[#003366]">
                +998 95 233 83 27
              </p>
            </div>
          </div>
