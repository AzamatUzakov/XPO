...
function GeographyMapInner() {
  ...
  return (
    <section id="geography-map" style={{ scrollMarginTop: "80px" }} className="relative left-1/2 -translate-x-1/2 w-screen bg-[#001E40] text-white overflow-hidden flex flex-col items-center py-12 sm:py-16 md:py-20">
      {/* Заголовок — fadeUp */}
      <motion.div
