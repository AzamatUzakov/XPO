...
const icons = [Clock, Calculator, ShieldCheck, Umbrella, MapPin, Globe];
...
export default function Advantages({ locale = "ru", translations = {} }) {
  return (
...
function AdvantagesInner() {
  const { translations } = useI18n();
  const advantages = translations.advantages || {};
  const title = advantages.title || "Наши преимущества";
